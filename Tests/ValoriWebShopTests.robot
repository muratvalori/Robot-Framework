...
TC-001 Should be able to run tests in different browsers
...
TC-002 Should be able to open webshop
...
TC_WS_001 Should be able to sign in webshop
...
TC_WS_003 Should not be able to login with valid email and invalid password
    [Documentation]     Enter an invalid username&password and try to sign in
...
TC_WS_004 Should not be able to login with invalid username and invalid password
    [Documentation]     Enter an invalid username&password and try to sign in
...
TC_WS_005 Should be able to create an account and confirm account has been created
...
TC_WS_006 Should not be able to create an account without using "@" in the email address
...
TC_WS_008 Should be able to add five items to cart and confirm those items are added to cart
...
TC_WS_009 Should be able to add address to existing user
...
TC_WS_010 Should be able to place an order and go to own address
...
TC_WS_011 Should be able to send a message about the order and confirm that the message is sent
...
TC_WS-012 Should be able to search for product and confirm that the product is found
...
TC_WS_013 Should be able to file a complaint and confirm that the complaint is filed
...
TC_WS_014 Should be able to delete user account and confirm that the account is deleted
